...
public class TrustedDeviceImplTest {
    ...
    public void testExtract() throws IOException {
        ...
        Meta meta = trustedDevice.extract(newMeta);
        assertEquals("", meta.getFazpassId());
    }
